...
hl.workspace_rule({ workspace = "4", monitor = MONITOR1, default = true, persistent = false })
hl.workspace_rule({ workspace = "5", monitor = MONITOR1, default = true, persistent = false })
hl.workspace_rule({ workspace = "6", monitor = MONITOR1, default = true, persistent = false })
hl.workspace_rule({ workspace = "7", monitor = MONITOR1, default = true, persistent = false })
hl.workspace_rule({ workspace = "8", monitor = MONITOR1, default = true, persistent = false })
hl.workspace_rule({ workspace = "9", monitor = MONITOR1, default = true, persistent = false })
hl.workspace_rule({ workspace = "10", monitor = MONITOR1, default = true, persistent = false })
